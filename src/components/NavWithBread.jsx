...
const navigation = [
  ...
  // { name: "Blog", href: "https://securedapp.in/blog/", special: true },
];
    ...
    <div className="z-[23432423423]">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav
          ...
          aria-label="Global"
        >
          <div className="flex lg:flex-1 lg:ml-[0px]">
          ...
          <div className="flex lg:hidden">
            <button
              type="button"
              className="-mt-2.5 -ml-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700"
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 bg-black z-50 w-full overflow-y-auto px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="-my-2.5 -ml-2.5 rounded-md p-2.5 text-gray-100"
...
export default NavbarWithBread;

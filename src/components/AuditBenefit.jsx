...
const AuditBenefit = () => {
  return (
    <div className="auditBenefit">
      <div className="lg:pl-[80px] lg:py-[80px]">
        <h1 className="text-white text-opacity-80 text-[32px] font-normal leading-[100%]">
          The benefits of smart contract auditing by SecureDApp include:
        </h1>
      </div>

      <div className="flex justify-evenly lg:pb-[50px]   ">
      ...
      <div className="lg:py-[50px] lg:px-[80px]">

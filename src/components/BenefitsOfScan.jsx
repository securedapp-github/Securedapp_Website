...
const BenefitsOfScan = () => {
  return (
    <div
      className="md:px-[100px]  md:py-[50px] lg:pb-[60px] py-[50px]  w-full mb-[0px] flex lg:flex-row flex-col gap-[60px]"
      style={{
        background:
          "radial-gradient(50% 75.00% at 0% 50.00%, rgba(18, 213, 118, 0.31) 0%, rgba(0, 0, 0, 0.00) 100%)",
      }}
    >

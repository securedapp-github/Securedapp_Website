  ...
  return (
    <>
      ...
      <div
        ...
        className="md:px-[80px] md:pt-[80px]  md:py-[50px] lg:pb-[60px] py-[50px] schield_benefit w-full mb-[0px] flex lg:flex-row flex-col gap-[60px]"
      >
        {" "}
        ...
        <div className="lg:w-5/12 lg:px-[0px] md:px-[0px] px-[50px] ">
          ...
          <div className="pb-[25px]">
            <input
              ...
              className="bg-transparent p-4 border rounded-[20px] text-white placeholder:text-[16px] placeholder:font-sans placeholder:text-[#FFF] placeholder:text-opacity-20 w-11/12 "
            />
          </div>
          <div className="pb-[25px]">
            <input
